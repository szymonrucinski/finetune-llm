...
python finetune_llama_v2.py --model_name meta-llama/Llama-2-7b-hf --dataset_name szymonindy/ociepa-raw-self-generated-instructions-pl --use_4bit --bf16 --bnb_4bit_compute_dtype bfloat16 --merge_and_push
