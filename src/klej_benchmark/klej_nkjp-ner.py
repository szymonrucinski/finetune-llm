...
model = AutoModelForSequenceClassification.from_pretrained(
    model_id, num_labels=6, problem_type="multi_class_classification"
)
...
result_file_path = base_file_path + "/test_pred_klej_nkjp.tsv"
print(result_file_path)
result_df["label"].to_csv(result_file_path, index=False, sep="\t")

artifact = wandb.Artifact("test_pred_klej_nkjp-ner", type="result")
